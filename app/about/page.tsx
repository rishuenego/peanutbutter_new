...
const values = [
  {
    ...
    description:
      "We select the best nuts and produce with zero harmful additives.",
  },
  {
    title: "Made With Love",
    description:
      "Every product is crafted with care to deliver unmatched taste.",
  },
  {
    title: "Energy & Wellness",
    description:
      "Nuttira products are designed to fuel your active lifestyle.",
  },
];
    ...
    <MainLayout>
      <div className="bg-amber-50">
        ...
        <div
          ...
          style={{
            background: "linear-gradient(135deg, #FDE5C6 0%, #FDD7AC 100%)",
          }}
        >
              ...
              {values.map((value, index) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[#3D1B00]/80 text-xs leading-relaxed">
                      {value.description}
                    </p>
                  </div>
                </div>
