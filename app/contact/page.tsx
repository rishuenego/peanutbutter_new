            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-amber-500 hover:bg-amber-600 text-white py-4 rounded-full font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
            ...
            <div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Office no - 808,8th floor The I conic corenthum tower
                        <br />
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                ...
                <div className="flex gap-4">
                  <a
                    href="#"
                    className="w-12 h-12 bg-amber-100 hover:bg-amber-500 rounded-full flex items-center justify-center transition-colors group"
                  >
                    <svg
