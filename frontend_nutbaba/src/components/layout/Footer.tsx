        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="bg-[#3D1B00] rounded-[20px] py-8 px-10 md:px-14 lg:px-16 flex flex-col lg:flex-row items-center justify-between gap-8 shadow-lg">
            <div className="text-center lg:text-left">
              <h3
                className="text-xl md:text-2xl font-bold text-white mb-1 whitespace-nowrap"
                style={{ fontFamily: "'Playfair Display', serif" }}
              >
                Subscribe to our newsletter
              </h3>
              <p
                className="text-sm md:text-base font-medium text-white/80 whitespace-nowrap"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="flex flex-col items-center lg:items-start">
              ...
              <form onSubmit={handleSubscribe} className="relative w-full max-w-[240px] mb-5">
                ...
                <input
                  ...
                  disabled={isSubscribing}
                  required
                  className="w-full pl-9 pr-5 py-2 rounded-full bg-[#FCF0E5] text-[#813302] text-[10px] focus:outline-none placeholder:text-[#813302]/60 font-medium disabled:opacity-50"
                  style={{ fontFamily: "'Inter', sans-serif" }}
                />
              </form>
              <div className="flex items-center gap-2">
                <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="w-6 h-6 flex items-center justify-center bg-white rounded-md hover:bg-[#C45C26] transition-colors group">
                  <Youtube className="h-3.5 w-3.5 text-[#3D1B00] group-hover:text-white" />
                </a>
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-6 h-6 flex items-center justify-center bg-white rounded-md hover:bg-[#C45C26] transition-colors group">
                  <Instagram className="h-3.5 w-3.5 text-[#3D1B00] group-hover:text-white" />
                </a>
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-6 h-6 flex items-center justify-center bg-white rounded-md hover:bg-[#C45C26] transition-colors group">
                  <Facebook className="h-3.5 w-3.5 text-[#3D1B00] group-hover:text-white" />
                </a>
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="w-6 h-6 flex items-center justify-center bg-white rounded-md hover:bg-[#C45C26] transition-colors group">
            ...
            <div className="text-center lg:text-left">
              ...
              <ul className="space-y-2">
                <li>
                  <Link to="/shop" className="text-white/80 hover:text-[#C45C26] transition-colors font-medium text-xs">
                    All Products
                  </Link>
                </li>
                <li>
                  <Link to="/about" className="text-white/80 hover:text-[#C45C26] transition-colors font-medium text-xs">
                    Our Story
                  </Link>
                </li>
                <li>
                  <Link to="/contact" className="text-white/80 hover:text-[#C45C26] transition-colors font-medium text-xs">
                    Contact
                  </Link>
                </li>
              </ul>
            ...
            <div className="text-center lg:text-left">
              ...
              <ul className="space-y-2">
                <li>
                  <Link to="/terms" className="text-white/80 hover:text-[#C45C26] transition-colors font-medium text-xs">
                    Terms Of Use
                  </Link>
                </li>
                <li>
                  <Link to="/privacy" className="text-white/80 hover:text-[#C45C26] transition-colors font-medium text-xs">
                    Privacy Policy
                  </Link>
                </li>
              </ul>
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="space-y-3 text-xs text-white/80 font-medium">
                ...
                <p>
                  <span className="text-white font-bold">Contact:</span><br />
                  <span className="leading-relaxed text-[10px] md:text-xs">
                    +91 9311318132, +91 96673 66712<br />
                  </span>

                  <span className="text-white font-bold">Address:</span><br />
                  <span className="leading-relaxed text-[10px] md:text-xs">
                    Office no - 808,8th floor The I conic corenthum tower noida sector - 62 uttar predash - 201301<br />
                  </span>
                </p>
              </div>
            </div>
